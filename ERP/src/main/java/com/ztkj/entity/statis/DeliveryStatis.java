...
public class DeliveryStatis {
	...
	public String toString() {
		return "DeliveryStatis [f_kName=" + f_kName + ", f_fzName=" + f_fzName + ", pro_name=" + pro_name
				+ ", city_name=" + city_name + ", f_count=" + f_count + ", f_money=" + f_money + ", startTime="
				+ startTime + ", endTime=" + endTime + ", pro_id=" + pro_id + ", city_id=" + city_id + "]";
	}
