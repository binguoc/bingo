...
public interface PurchaseMapper {
	...
	List<PurchaseVo> queryStatus(@Param("vo")PurchaseVo vo,@Param("userName")String userName) throws Exception;
	...
	List<PurchaseAudutVo> queryAllUser(Integer integer) throws Exception;
}
