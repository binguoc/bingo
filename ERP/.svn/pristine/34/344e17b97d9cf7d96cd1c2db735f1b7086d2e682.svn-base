 ...
 * @returns
 */
function queryDeliveryView(){  
	var data=getUrlParam("f_kName");
	$.ajax({
	    url:"deliveryView.action",
	    data:{"f_kName":data},
		async:false,
		dataType:"json",
		type:"post",
	    success:function(result){
			...
			$(result.list).each(function(){
				...
				trs+="<td>"+this.f_ckName+"</td>";
			    trs+="<td>";
				trs+="<a href='../../storage/delivery/deliveryView.html?id="+this.f_did+"' class='tablelink'>查看详情 </a>";
				trs+="</td>";
				trs+="</tr>"; 
				i++;
			  });
